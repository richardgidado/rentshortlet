  ...
  const features = [
    {
      ...
      description: "Every property is personally inspected and verified for quality and comfort."
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "24/7 Support",
      description: "Round-the-clock customer support to assist you with your stay."
    }
  ];
